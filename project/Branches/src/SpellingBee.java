...
public class SpellingBee {
	...
	public static void main(String[] args) throws FileNotFoundException {
		...
		for(int i = 0; i<127; i++) {
			String potentialword = new String();
		...
		while(true) {
			...
			if(!ispanagram) {
				System.out.println("you scored " + curpoints + ((curpoints == 1) ?  " point" : " points") + " with this word");
			}else {
				System.out.println("Panagram! you scored " + curpoints + ((curpoints == 1) ?  " point" : " points") + " with the panagram");
			}
